...
fontsize = 18
## lunch time
# dropout 2 epoch 200 learning rate 5e-3 batch size 32
...
plt.title('Lunchtime occupancy example', fontsize=18)
plt.legend()
plt.show()
...
# lunch time (presanitized)
with open('result_linear_new/lunchtime_presanitized.pickle', 'rb') as f:
    anonymity_levels, losses_best, losses_generic, losses_linear, \
    losses_deep, distances_lm, distances_dm, distances_gt = pickle.load(f)
